  ...
  "captain_aldric_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Tell me about the Catacombs.",
            "action": "goto",
            "target": "catacombs_info"
          },
          {
            "text": "I'll investigate.",
            "action": "quest_offer",
            "questId": "mq_01_shadows"
          },
          {
            "text": "Any missing guard reports?",
            "action": "quest_offer",
            "questId": "sq_ash_02_missing_guard"
          },
          {
            "text": "Goodbye.",
            "action": "close"
  ...
  "innkeeper_mira_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "I'd like to rest. (10 gold — full HP/MP)",
            "action": "rest"
          },
          {
          ...
          {
            "text": "About that missing ale shipment...",
            "action": "quest_offer",
            "questId": "sq_ash_03_inn_ale"
          },
          {
  ...
  "merchant_bram_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "I'll escort you to Millhaven.",
            "action": "quest_offer",
            "questId": "sq_ash_04_escort"
          },
          {
            "text": "Lost something?",
            "action": "quest_offer",
            "questId": "sq_river_02_trader"
          },
          {
  ...
  "scholar_emelyn_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "I found something in the Catacombs.",
            "action": "quest_offer",
            "questId": "mq_02_source"
          },
          {
            "text": "What can you tell me about Hollowmire?",
            "action": "goto",
            "target": "hollowmire_info"
          },
          {
            "text": "Just browsing.",
            "action": "close"
  ...
  "archmage_thalys_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "I'm ready for the trial.",
            "action": "quest_offer",
            "questId": "mq_03_mage_trial"
          },
          {
            "text": "Tell me more about the Hollow Pact.",
            "action": "goto",
            "target": "pact_info"
          },
          {
            "text": "I've completed the trial.",
            "action": "quest_offer",
            "questId": "mq_04_hollowmire"
          },
          {
            "text": "Not yet.",
            "action": "close"
  ...
  "apothecary_selene_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Browse remedies.",
            "action": "open_shop"
          },
          {
            "text": "I can gather Swamp Lotus.",
            "action": "quest_offer",
            "questId": "sq_mill_01_herbs"
          },
          {
            "text": "Not today.",
            "action": "close"
  ...
  "mage_proctor_venn_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Tell me about the challenge.",
            "action": "quest_offer",
            "questId": "sq_mill_02_mage_trial_proctor"
          },
          {
            "text": "Not today.",
            "action": "close"
  ...
  "escort_warning_mild": {
    ...
    "nodes": {
      "warn": {
        ...
        "choices": [
          {
            "text": "You're right, back to the road.",
            "action": "close"
          },
          {
            "text": "I know a shortcut, trust me.",
            "action": "close"
          }
        ]
      }
  ...
  "escort_warning_urgent": {
    ...
    "nodes": {
      "warn": {
        ...
        "choices": [
          {
            "text": "Alright! We're going back now.",
            "action": "close"
          }
        ]
      }
  ...
  "tavern_brawler_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Let's settle this outside... or right here.",
            "action": "goto",
            "target": "challenge"
          },
          {
            "text": "Not interested in trouble.",
            "action": "close"
          }
        ]
      },
  ...
  "tavern_brawler_draw": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Somewhere dangerous, probably.",
            "action": "goto",
            "target": "invite"
          },
          {
            "text": "Thanks for the brawl.",
            "action": "close"
          }
        ]
      },
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          ...
          {
            "text": "Think you could vouch for Pip and Nara?",
            "action": "goto",
            "target": "vouch_prompt"
          }
        ]
  ...
  "tavern_thief_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Come with me instead. Better than a cell.",
            "action": "goto",
            "target": "recruit"
          },
          {
            "text": "I'm calling the guard.",
            "action": "close"
          }
        ]
      },
      "recruit": {
        ...
        "choices": [
          {
            "text": "Deal. Welcome aboard, Pip.",
            "action": "join_party"
          },
          {
            "text": "On second thought, get lost.",
            "action": "close"
          }
        ]
      }
  ...
  "party_healer_inn": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "Sounds like steady work.",
            "action": "close"
          },
          {
            "text": "What kind of interesting?",
            "action": "goto",
            "target": "curious"
          }
        ]
  ...
  "party_healer_default": {
    ...
    "nodes": {
      ...
      "introduction": {
        ...
        "choices": [
          {
            "text": "I'd be glad to have a healer with me.",
            "action": "join_party"
          },
          {
            "text": "I appreciate the patch-up. Safe travels.",
            "action": "close"
          }
        ]
      }
  ...
  "farmer_hess_default": {
    ...
    "nodes": {
      "greeting": {
        ...
        "choices": [
          {
            "text": "I'll find your son.",
            "action": "quest_offer",
            "questId": "sq_farm_01_son"
          },
          {
            "text": "I'll deal with the Mire Crawlers.",
            "action": "quest_offer",
            "questId": "sq_farm_02_swamp"
          },
          {
            "text": "Stay safe.",
            "action": "close"
